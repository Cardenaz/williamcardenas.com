...
But of course, just because something depends on magnetization it does not mean that the transmitted current is SP. Although I am wondering if we could probe the current with a quantum dot spin and get a read out.